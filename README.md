...
```bash
# Клонируйте репозиторий (main ветка - стабильная версия)
...
- ✅ Создаст виртуальное окружение Python (совместимость с Debian 12+/Ubuntu 23.04+)
- ✅ Установит все зависимости (Python, Nginx, SQLite)
- ✅ Настроит systemd сервис
- ✅ Найдёт и интегрируется с существующей конфигурацией Nginx (если есть)
- ✅ Использует ваш домен и SSL сертификаты (если настроены)
- ✅ Предложит установить SSL сертификат Let's Encrypt

### Системные требования:

- **ОС**: Debian 11+, Ubuntu 20.04+
- **Python**: 3.8+ (скрипт проверяет автоматически)
- **3x-ui**: Любая версия (автоматическая совместимость)
- **Root доступ**: Требуется для установки

После установки откройте в браузере:
- **XUI-Manager**: `https://ваш-домен/manager/`
- **API Docs**: `https://ваш-домен/manager/api/docs`
- **3x-ui панель**: `https://ваш-домен/esmars/`

> **Примечание:** Для установки через SSH с приватным ключом см. [PRIVATE_DEPLOY.md](PRIVATE_DEPLOY.md)
